  ...
  const experiences = [
    {
      ...
      description:
        "Developing AI agents to enhance the functionality and user engagement of social media applications.",
    ...
    },
    {
      ...
      organization: "Nitte",
      description:
        "Utilizing Deep Learning for early breast cancer diagnosis and prognostic prediction.",
  ...
  return (
    <div className="w-full h-screen overflow-auto">
      <div className="zoom-container">
        <div
          className="min-h-screen w-full flex flex-col items-center justify-start p-6 relative"
            ...
            >
              {experiences.map((exp, index) => (
                ...
                >
                  ...
                  {exp.organization && (
                    <div className="text-[#5BCEFA] font-medium">{exp.organization}</div>
                  )}
